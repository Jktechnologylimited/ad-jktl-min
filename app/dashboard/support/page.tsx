...
// Honest pending state -- this module ships in Batch 10 per the approved
  ...
  return (
    <div style={{ padding: "clamp(20px,4vw,36px)", fontFamily: font.sans }}>
      <div style={{ maxWidth: 440, margin: "60px auto 0", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#fff", marginBottom: 8 }}>Support is coming</h1>
        <p style={{ fontSize: "0.85rem", color: colors.textLow, lineHeight: 1.6 }}>
          This module is scheduled for Batch 10 of the JKTL platform build. The nav entry is live now so the information architecture is in place -- the feature itself will land in its approved batch.
        </p>
      </div>
    </div>
  );
