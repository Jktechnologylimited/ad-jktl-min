  ...
  return (
    <div style={{ padding:"clamp(20px,4vw,36px)", fontFamily:"'Plus Jakarta Sans',sans-serif", maxWidth:1400 }}>
      <div style={{ marginBottom:24 }}>
        <h1 style={{ fontSize:"clamp(1.1rem,3vw,1.4rem)", fontWeight:700, color:"#fff", marginBottom:2 }}>Onboarding Sessions</h1>
        <p style={{ fontSize:"0.82rem", color:"rgba(226,232,240,0.4)" }}>Track signups in progress and abandoned sessions</p>
      </div>
